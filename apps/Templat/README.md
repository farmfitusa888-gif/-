...
Its logic is proven anyway: [`../ts/src/templat/`](../ts/src/templat/) is a
line-for-line TypeScript port of this core, and
[`../ts/test/templat.test.ts`](../ts/test/templat.test.ts) runs the same assertions
as `Tests/TemplatCoreTests`. `cd ../ts && npm test` executes them.
